package com.shinjaehun.oreumola.services
...
import com.shinjaehun.oreumola.other.Constants.FASTEST_LOCATION_INTERVAL
import com.shinjaehun.oreumola.other.Constants.LOCATION_UPDATE_INTERVAL
import com.shinjaehun.oreumola.other.Constants.NOTIFICATION_CHANNEL_ID
import com.shinjaehun.oreumola.other.Constants.NOTIFICATION_CHANNEL_NAME
import com.shinjaehun.oreumola.other.Constants.NOTIFICATION_ID
import com.shinjaehun.oreumola.other.Constants.TIMER_UPDATE_INTERVAL
...
//        val pathPoints = MutableLiveData<MutableList<MutableList<LatLng>>>()
        ...
        if(isTracking){
            if(TrackingUtility.hasLocationPermissions(this)){
                ...
                fusedLocationProviderClient.requestLocationUpdates(
                    ...
                    // 빌어먹을 permission 라이브러리 안 쓰면 굳이 supresslint하지 않아도 된다고 함!
                )
            }
        } else {
    ...
    private fun getMainActivityPendingIntent() = PendingIntent.getActivity(
        ...
        FLAG_UPDATE_CURRENT or FLAG_UPDATE_CURRENT
    )
